<?php 
 ...
 $jayParsedAry = [
   [
         ...
         "slug" => "legacy-led", 
         "shortDescrioption" => "El Led es un suplemento natural que se puede preparar en una bebida antioxidante y energética que contribuye a la eliminación de cálculos y quistes, a fin de evitar situaciones que puedan ocasionar molestias.", 
   ...
   [
            ...
            "slug" => "legacy-avi", 
            "shortDescrioption" => "Avi es un suplemento natural que aporta colágeno, un componente esencial para la salud de tus huesos y músculos. Este colágeno se integra perfectamente en tu rutina diaria, ayudando no solo a fortalecer tu sistema óseo, sino también a mejorar la elasticidad de la piel.", 
   ...
   [
               ...
               "slug" => "legacy-kle", 
               "shortDescrioption" => "El café Kled no solo proporciona energía, sino que también actúa como un aliado en la reducción de ansiedad, eleva tu sistema inmunológico. Sus ingredientes naturales ayudan a combatir refriados, gripe y la hipertensión.", 
   ...
   [
                  ...
                  "shortDescrioption" => "El suplemento Wu se destaca por su capacidad para eliminar el colesterol y acelerar el metabolismo. También ayuda a eliminar la retención de líquidos y toxinas del cuerpo. Estos efectos están respaldados por los antioxidantes presentes en sus ingredientes.", 
   ...
   [
                     ...
                     "slug" => "legacy-alc", 
                     "shortDescrioption" => "El Alc es un suplemento que se presenta como una bebida proteínica rica en nutrientes, diseñada para combatir la desnutrición y la anemia. Su fórmula única también ayuda a controlar el colesterol y a mejorar el sistema digestivo.", 
   ...
   [
                           ...
                           "shortDescrioption" => "Wu Green Mix es un suplemento natural diseñado para aportar nutrientes y minerales esenciales al cuerpo. Su formulación única se enfoca en mejorar la salud en la circulación sanguínea, la protección del corazón, y el control de los niveles de glucosa en sangre.", 
   ...
   [
                              ...
                              "slug" => "legacy-led2", 
                              "shortDescrioption" => "Led 2 es una bebida innovadora diseñada para estimular la creatividad y mejorar la concentración. Con su mezcla única de ingredientes naturales, esta bebida está enfocada en ayudar a quienes buscan un impulso mental y físico a lo largo del día.", 
...
$productsDescription = [
   ...
   [
       "title" => "Wu Green Mix: Los nutrientes que tu cuerpo necesita",
       "image" => "wurtx",
       "description" => "Wu Green Mix es un suplemento natural diseñado para aportar nutrientes y minerales esenciales al cuerpo. Su formulación única se enfoca en mejorar la salud en la circulación sanguínea, la protección del corazón, y el control de los niveles de glucosa en sangre.",
       "cost" => "50"
   ],
   [
       "title" => "Led 2: Potencia Tu Creatividad",
