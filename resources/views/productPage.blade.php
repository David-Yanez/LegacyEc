...
<div class="flex flex-col items-center">
    ...
    <h2 class=" text-3xl font-semibold mb-8">Wu: Quemador y regulador de grasa natural</h2>
    <figure>
    ...
    <div class=" w-2/5 my-10  text-center text-xl ">
      ...
      <p>Nos apasiona presentarte a RED, el producto orientado a la
        plenitud sexual de Legacy Global que viene a encender la
        pasión en tu vida.</p>
        <p>Con súper frutos e insumos ancestralmente reconocidos por
            sus beneficios en la limpieza de toxinas y vías urinarias,
            mejora en la presión sanguínea y efectos afrodisiacos,
            podrás repotenciar tu bienestar sexual de manera integral.</p>
            <p>¡Con RED, vive tu sexualidad con plenitud y salud!</p>
    ...
    <div class="flex items-center ">
        <ul><li class=" border border-black p-2 rounded-xl my-3 shadow-md shadow-yellow-200 hover:scale-110">
    ...
    <div class="flex items-center">
        ...
        <figure>
            <img src="/img/products/wu/wu4.webp" alt="">
        </figure>
        <ul><li>
            Poderoso Antioxidante 
            </li>
